...
func show_dialog( _item : Array[DialogItem] ) -> void:
	is_active = true
...
func set_dialog_text( _d : DialogText ) -> void:
	...
	portrait_sprite.texture = _d.npc_info.protrait
...
func show_dialog_button_indicator( _is_visible : bool ) -> void:
	...
	if dialog_item_index + 1 < dialog_items.size():
		dialog_progress_indicater_label.text = "NEXT"
	else:
		dialog_progress_indicater_label.text = "END"
